...
class LangSAMTrackerNode(Node):
    ...
    def _log_configuration(self):
        ...
        self.get_logger().info(f"C++ CSRT: {self.csrt_client.is_available()}")
        self.get_logger().info(f"Active Trackers: {self.csrt_client.get_tracker_count()}")
                ...
                if should_run_gdino:
                    ...
                    if detections:
                        ...
                        if detection_boxes:
                            ...
                            self.get_logger().info(f"C++ CSRT initialized {len(csrt_results)} trackers")
                    ...
                    if csrt_results:
                        ...
                        csrt_detections = []
                        for i, bbox_tuple in enumerate(csrt_results):
                            x, y, w, h = bbox_tuple
